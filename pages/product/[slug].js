            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <button
                  ...
                  className="flex ml-4 text-white bg-pink-500 border-0 py-2 px-1 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  &nbsp;Add to Cart&nbsp;
                </button>
              ...
              {service && service != null && (
                <div className="text-green-700 mt-3 text-sm">
                  Yayy! This pincode is serviceable.
                </div>
              )}
            </div>
          </div>
...
export async function getServerSideProps(context) {
  ...
  let colorSizeSlug = {}; //{red: {Xxl: {slug: 'wear-the-code-xl'}}}
